  ...
  return (
    <div className="font-sans text-gray-900">
      ...
      <section className="container mx-auto px-6 grid md:grid-cols-2 gap-8">
        ...
        <div>
          ...
          <div className="space-y-4">
            {/* Address */}
            <div className="flex items-center space-x-3 bg-sky-200 p-3 rounded-md">
      ...
      <section className="py-16 mt-12">
        <div className="container mx-auto px-6 grid md:grid-cols-2 gap-8 items-center rounded-lg shadow-md">
          {/* Left - FAQ */}
          <div>
