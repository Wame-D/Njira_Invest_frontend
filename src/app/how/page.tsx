                ...
                <div className="h-full w-full inside-how pt-20 items-center flex flex-col justify-center">
                    ...
                    <div className="flex body-div">
                        <div className="cards flex flex-col">
                            ...
                            <div className="w-full flex flex-row m-3 number1-div">
                            ...
                            <div className="w-full flex flex-row m-3 number2-div">
                        ...
                        <div className="cards flex flex-col">
                            ...
                            <div className="w-full flex flex-row m-3 number3-div">
                            ...
                            <div className="w-full flex flex-row m-3 number4-div">
