...
const AccountDashboard = () => {
  ...
  const embeddedDashboardId = "fe81ff49-cf20-4bf1-8b29-ec2b25a5ee27";
  ...
  useEffect(() => {
    ...
    const mountPoint = document.getElementById("account-dashboard-container");
  ...
  return (
    <>
      <div id="account-dashboard-wrapper">
        <div id="account-dashboard-container" className="w-screen h-screen">
        </div>
      </div>
    </>
  );
